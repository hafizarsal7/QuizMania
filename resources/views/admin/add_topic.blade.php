          ...
          {{ csrf_field() }}
            <div class="row row-lg">
              <div class="col-lg-6 form-horizontal">
                <div class="form-group">
                  <label class="col-lg-12 col-sm-3 control-label">Topic
                    <span class="required">*</span>
                  </label>
                  <div class=" col-lg-12 col-sm-9">
                    <input type="text" class="form-control" name="topic" placeholder="John Fish"
                    required="">
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-lg-12 col-sm-3 control-label">Subject
                    <span class="required">*</span>
                  </label>
                  <div class=" col-lg-12 col-sm-9">
                    <select class="form-control" name="subject[]" multiple data-plugin="select2">
                ...
                <div class="form-group">
                  <label class="col-lg-12 col-sm-3 control-label">Description
                    <span class="required">*</span>
                  </label>
                  <div class="col-lg-12 col-sm-9">
                ...
                <div class="form-group">
                  <label class="col-lg-12 col-sm-3 control-label">Status</label>
                  <div class="col-lg-12 col-sm-9">
