...
<head>
  ...
  <title>All subject | Admin Panel</title>
  ...
  <style>
    ...
    @media (min-width: 768px) {
      #subjectform .form-horizontal .control-label {
        text-align: inherit;
      }
    }
  </style>
...
<body>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="400.html" data-slug="page-error-400">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">View All Subjects</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="403.html" data-slug="page-error-403">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Add New Subject</span>
                  </a>
                </li>
              </ul>
            </li>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">All Subject</h1>
      <ol class="breadcrumb">
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered">
                  ...
                  @foreach($subject as $subjects)
                    <tr>
                      <td><a href="javascript:void(0)">{{ $subjects->id }}</a></td>
                      <td>{{ $subjects->Name }}</td>
                      <td>
                        <div class="label label-table label-success">{{ $subjects->Status }}</div>
                      </td>
                      <td class="text-nowrap">
                          <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-id="{{$subjects->id}}" data-toggle="tooltip" onclick="loadModal('<?php echo htmlspecialchars(json_encode($subjects)); ?>')" name="{{$subjects->id}}" data-original-title="Edit">
                            <i class="icon wb-wrench" aria-hidden="true" data-toggle="modal" data-target="#edit-subject"></i>
                          </button>
                          <button type="button" id="delete-subject" value="{{ $subjects->id }}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Delete">
  ...
  <!-- Modal -->
  @foreach($subject as $subjects)
  <div class="modal fade" id="edit-subject" aria-hidden="true" aria-labelledby="examplePositionSidebar" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-sidebar modal-custom">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="exampleFullForm" autocomplete="off" method="POST" action="/admin/updateSubject">
          {{ csrf_field() }}
              ...
              <div class="col-lg-12 form-horizontal">
                <div class="form-group">
                  ...
                  <div class=" col-lg-12 col-sm-9">
                    <input type="text" class="form-control" id="Name" name="Name" placeholder="John Fish" value="{{$subjects->Name}}" required="">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-12 col-sm-9">
                    <div class="input-group">
                      <textarea class="form-control" id="Description" name="Description" value="{{$subjects->Description}}" required=""></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-12 col-sm-9">
                    <select class="form-control" id="Status" name="Status" value="{{$subjects->Status}}" required="">
  ...
  <script type="text/javascript">
    function loadModal(obj){
      ...
      $("#id").val(obj.id);
      $('#Status').val(obj.Status).attr("selected", "selected");
    }
  </script>
