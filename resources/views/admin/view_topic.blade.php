...
<body>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="400.html" data-slug="page-error-400">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">View All Topics</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="403.html" data-slug="page-error-403">
                    <i class="site-menu-icon " aria-hidden="true"></i>
                    <span class="site-menu-title">Add New Topic</span>
                  </a>
                </li>
              </ul>
            </li>
  ...
  <div class="page animsition">
    <div class="page-header">
      <h1 class="page-title">All Topic</h1>
      <ol class="breadcrumb">
              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  @foreach($topic as $topics)
                    <tr>
                      <td><a href="javascript:void(0)">{{ $topics->id }}</a></td>
                      <td>{{ $topics->topic }}</td>
                      <td>{{ $topics->Name }}</td>
                      <td>
                      ...
                      <td class="text-nowrap">
                          <button type="button" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="modal" data-target="#edit-topic" onclick="loadModal('<?php echo htmlspecialchars(json_encode($topics)); ?>')" name="{{$topics->id}}" data-original-title="Edit">
                            <i class="icon wb-wrench" aria-hidden="true" ></i>
                          </button>
                          <button type="button" id="delete-topic" value="{{ $topics->id }}" class="btn btn-sm btn-icon btn-flat btn-default" data-toggle="tooltip" data-original-title="Delete">
  ...
  <!-- Modal -->
  @foreach($topic as $topics)
  <div class="modal fade" id="edit-topic" aria-hidden="true" aria-labelledby="examplePositionSidebar" role="dialog" tabindex="-1">
    <div class="modal-dialog modal-sidebar modal-custom">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="exampleFullForm" autocomplete="off" method="POST" action="/admin/updatetopic">
          {{ csrf_field() }}
              ...
              <div class="col-lg-12 form-horizontal">
                <div class="form-group">
                  ...
                  <div class=" col-lg-12 col-sm-9">
                    <input type="text" class="form-control" id="topic" name="topic" value="{{$topics->topic}}" placeholder="John"
                    required="">
                  </div>
                  <input type="hidden" id="id" name="id" value="{{ $topics->id }}">
                </div>
                <div class="form-group">
                  <label class="col-lg-2 control-label">Description</label>
                  <div class="col-lg-12 col-sm-9">
                    <div class="input-group">
                      <textarea class="form-control" id="description" name="description" value="{{$topics->description}}" required=""></textarea>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-lg-12 col-sm-9">
                    <select class="form-control" id="status" name="status" value="{{$topics->status}}" required="">
